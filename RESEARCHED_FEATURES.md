...
## GHI 4.0 implementation status

See `docs/GHI_4.0_UPGRADE_RESEARCH.md` for the implemented investigation engine, local agent, ProjectDiscovery Chaos integration, and glass UI changes.
